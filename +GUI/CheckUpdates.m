...
try
    % Get repo
    folder = fileparts(which("GUIRestingStatePreprocessing.m"));
    repo = gitrepo(folder);
    ...
    if indCurrent > 1
        ...
        warningTraceless("There are changes available from GitHub. When you are ready to update, either pull these changes manually or call ""GUI.PullUpdates"".")
    else
