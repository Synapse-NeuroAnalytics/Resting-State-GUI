% RunApp.m
% Convenience launcher for the fNIRS Preprocessing GUIRestingState.
...
% first).
%
% The app's own startupFcn (App.mlapp) calls GUIRestingState.startup(app) once the
...
GUIRestingState.CheckUpdates;


%% Start App
app = GUIRestingState.App(); %#ok<NASGU>
