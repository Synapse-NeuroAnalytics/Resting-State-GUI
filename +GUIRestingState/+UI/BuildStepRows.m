...
for r = 1:nRows
    switch rowSpecs{r}
        case "master_controls"
            ...
            masterSwitch.ValueChangedFcn = @(src, event) GUIRestingState.Callbacks.GenAllFiguresChanged(app, event);
        ...
        case "step"
            i = rowStepIdx(r);
            rowPanel = GUIRestingState.UI.BuildOneStepRow(app, i);
            rowPanel.Layout.Row = r; 
            rowPanel.Layout.Column = 1;
    end
end

GUIRestingState.UI.RefreshStepRows(app, 1:n);
end